...
class DatabaseLightningService(service: LightningService, debitsDAO: DebitsDAO, invoicesDAO: LightningInvoicesDAO)(
  ...
  def invoiceWithDescriptionHash(i: InvoiceWithDescriptionHash): Future[
    Response[Either[LightningRequestError, CreateInvoiceWithDescriptionHash]]
  ] =
